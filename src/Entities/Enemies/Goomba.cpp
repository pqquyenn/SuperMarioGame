...
void Goomba::render(sf::RenderWindow& window) const {
    ...
    if (sprite.getTexture() != nullptr) {
        ...
        // Fallback: Vẽ hình chữ nhật màu nâu đại diện cho Goomba (Bẹp xuống khi bị dẫm)
        ...
        shape.setFillColor(squished ? sf::Color(139, 69, 19) : sf::Color(210, 105, 30));
...
float Goomba::getSquishTimer() const {
    return squishTimer;
}
